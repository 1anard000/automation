# Career Events & Conferences — APAC 2026

Track relevant networking events, conferences, and meetups in target cities.
...
### Shenzhen
- [ ] **CHINAOSS (China Open Source Summit)** — Typically August in Shenzhen. Product/strategy tracks. **Target contacts:** ByteDance, Alibaba teams.
...
- **HK:** Startup Grind HK (mid-month), ProductTank HK (3rd Thu), FinTechHK (various), HKPC tech events
- **SZ:** Shenzhen Startup Week (Oct), SZ Cross-border Commerce Meetup (monthly), Qianhai tech events
- **SH:** Shanghai PM Meetup (monthly), TechNode events (various), Shanghai AI events
- **SG:** ProductTank SG (2nd Tue), Startup Grind SG (last Wed), SGTech events, Infocomm Media events

---

## 📋 EVENT TRACKING

| Date | Event | City | Type | Target Contacts | Contacts Made | Follow-up |
|------|-------|------|------|-----------------|---------------|-----------|
...
### Who to Meet at Events
1. **Hiring managers** at target companies (Shopee, ByteDance, Airwallex, etc.)
2. **Other senior PM/strategy people** — potential referrals
3. **Recruiters** specializing in APAC tech
4. **Investors** (if exploring startup path)

### Event Prep Checklist
- [ ] Research attendee list / speaker lineup
- [ ] Identify 3-5 people to connect with
- [ ] Prepare 30-second pitch (cross-border commerce + US-China bridge)
- [ ] Bring business cards or WeChat QR
- [ ] Follow up within 48 hours on LinkedIn/WeChat

### Post-Event Follow-up
- Add contacts to contacts database
